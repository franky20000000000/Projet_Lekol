...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;300;400;500;700;900&display=swap">
...
<body class="overflow-x-hidden">
   <!------------------------------------ entete ------------------------------------>
        <header id="navbar" class="fixed flex md:justify-around justify-between z-50 items-center p-4 shadow-[0_0.5px_6px_rgba(0,0,0,0.1)] w-full text-xl">
            ...
            // Déterminer le type d'utilisateur et le lien de profil
            $type_utilisateur = $_SESSION['type_utilisateur'] ?? 'parent';
            
            if ($type_utilisateur === 'repetiteur') {
                $lien_profil = 'ProfilRepetiteur.php';
            } else {
                $lien_profil = 'ProfilParent.php';
            }
